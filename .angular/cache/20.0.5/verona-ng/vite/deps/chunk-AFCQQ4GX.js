...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, p2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $(), it = k(), lt = h(), L, N2, ot = "top";
...
//# sourceMappingURL=chunk-AFCQQ4GX.js.map
