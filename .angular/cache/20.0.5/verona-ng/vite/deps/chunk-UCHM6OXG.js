...
function D(t2, e, o = true) {
  var n2, r, i3, l3;
  if (t2) {
    let d3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d3.height, a2 = d3.width, u2 = e.offsetHeight, c3 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $2(), it = k2(), lt = h2(), L, N2, ot = "top";
    f2.top + u2 + s4 > lt.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u2 + f2.top + g3, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c3 - a2) : N2 = f2.left + it, V2(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n2 = x(/-anchor-gutter$/)) == null ? void 0 : n2.value) != null ? r : "2px"} * -1)` : (l3 = (i3 = x(/-anchor-gutter$/)) == null ? void 0 : i3.value) != null ? l3 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n2 = void 0) {
  var r;
  if (t2) {
    let i3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), l3 = e.offsetHeight, d3 = e.getBoundingClientRect(), s4 = h2(), a2, u2, c3 = n2 != null ? n2 : "top";
...
function zt(t2, e) {
  var o, n2;
  if (t2) {
    let r = t2.parentElement, i3 = K2(r), l3 = h2(), d3 = t2.offsetParent ? t2.offsetWidth : J2(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u2 = C2((n2 = r == null ? void 0 : r.children) == null ? void 0 : n2[0]), c3 = "", f2 = "";
    i3.left + a2 + d3 > l3.width - O2() ? i3.left < d3 ? e % 2 === 1 ? c3 = i3.left ? "-" + i3.left + "px" : "100%" : e % 2 === 0 && (c3 = l3.width - d3 - O2() + "px") : c3 = "-100%" : c3 = "100%", t2.getBoundingClientRect().top + u2 + s4 > l3.height ? f2 = `-${s4 - u2}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = c3;
  }
}
function Zt(t2) {
  var e;
...
var d2 = (t2, e, a2) => e in t2 ? p3(t2, e, { enumerable: true, configurable: true, writable: true, value: a2 }) : t2[e] = a2;
var n = (t2, e) => {
  for (var a2 in e || (e = {})) x2.call(e, a2) && d2(t2, a2, e[a2]);
  if (i2) for (var a2 of i2(e)) c2.call(e, a2) && d2(t2, a2, e[a2]);
  return t2;
};
function u(...t2) {
  if (t2) {
...
//# sourceMappingURL=chunk-UCHM6OXG.js.map
