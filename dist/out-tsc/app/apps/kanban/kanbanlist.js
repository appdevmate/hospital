...
let KanbanList = class KanbanList {
    parent;
    kanbanService;
    list;
    listIds;
...
__decorate([
    Input()
], KanbanList.prototype, "list", void 0);
__decorate([
    Input()
], KanbanList.prototype, "listIds", void 0);
__decorate([
    ViewChild('inputEl')
], KanbanList.prototype, "inputEl", void 0);
__decorate([
    ViewChild('listEl')
], KanbanList.prototype, "listEl", void 0);
KanbanList = __decorate([
    Component({
