...
let MailReplyComponent = class MailReplyComponent {
    messageService;
    mailService;
    newMail = {
        id: '',
...
__decorate([
    Input()
], MailReplyComponent.prototype, "content", void 0);
__decorate([
    Output()
], MailReplyComponent.prototype, "hide", void 0);
