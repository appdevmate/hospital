...
let DocumentManagerComponent = class DocumentManagerComponent {
    ...
    constructor(documentService, helpers, confirmationService) {
    ...
    //     input.value = '';
    // }
    onUploadHandler(event, fileUploader) {
        this.uploadFiles(event.files, 0, fileUploader);
    }
    uploadFiles(files, index, fileUploader) {
...
__decorate([
    ViewChild('fileNameTpl')
], DocumentManagerComponent.prototype, "fileNameTpl", void 0);
__decorate([
    ViewChild('sizeTpl')
], DocumentManagerComponent.prototype, "sizeTpl", void 0);
