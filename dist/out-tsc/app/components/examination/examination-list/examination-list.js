...
let ExaminationListComponent = class ExaminationListComponent {
    patientId;
    patientName = '';
...
__decorate([
    Input({ required: true })
], ExaminationListComponent.prototype, "patientId", void 0);
__decorate([
    Input()
], ExaminationListComponent.prototype, "patientName", void 0);
ExaminationListComponent = __decorate([
    Component({
...
export { ExaminationListComponent };
