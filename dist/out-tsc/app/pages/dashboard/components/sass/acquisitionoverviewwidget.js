...
let AcquisitionOverviewWidget = class AcquisitionOverviewWidget {
    overviewWeeks = [
        { name: 'Last Week', code: '0' },
        { name: 'This Week', code: '1' }
    ];
    selectedOverviewWeek = { name: 'This Week', code: '1' };
    overviewChartData;
...
AcquisitionOverviewWidget = __decorate([
    Component({
...
export { AcquisitionOverviewWidget };
