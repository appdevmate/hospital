...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, ReactiveFormsModule, CardModule, InputTextModule, DatePickerModule, AutoCompleteModule, InputMaskModule, ButtonModule, ToastModule, FloatLabelModule],
                ...
                <form [formGroup]="form" (ngSubmit)="submit()" class="form-content" autocomplete="off">
                    ...
                    <div class="form-row">
                        <div class="form-field form-field-half">
                            <p-floatlabel variant="on">
                                <p-datepicker id="dob" formControlName="dob" [showIcon]="true" dateFormat="dd/MM/yy" [maxDate]="today" [showOnFocus]="false" [class.p-invalid]="invalid('dob')" [readonlyInput]="true" styleClass="w-full" />
