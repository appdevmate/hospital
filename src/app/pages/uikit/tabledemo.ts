...
import { catchError, finalize, map, mergeMap, toArray, takeUntil } from 'rxjs/operators';
import { GenericTableComponent, TableColumn, TableConfig, RowEditEvent, ToolbarConfig, FilterControl } from './tableplugin';
...
export class TableDemo implements AfterViewInit, OnDestroy {
    ...
    // Define dynamic filter controls once; add more freely
    ...
    loadPatients(e: any) {
        ...
        // Reconcile quick params from activeFilters
