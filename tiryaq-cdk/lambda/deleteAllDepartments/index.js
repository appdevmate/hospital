...
exports.handler = async (event = {}) => {
  ...
  try {
    ...
    if (!keys.length) {
      const r0 = { statusCode: 200, body: JSON.stringify({ message: 'No departments found', deleted: 0 }) };
    ...
    const response = { statusCode: 200, body: JSON.stringify({ message: 'All departments deleted', deleted }) };
